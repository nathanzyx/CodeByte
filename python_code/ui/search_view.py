...
class SearchView:
    ...
    def setup_ui(self):
        ...
        header.pack(fill=ctk.X, pady=15)
        ctk.CTkLabel(header, 
        ...
        for idx, field in enumerate(fields):
            btn = ctk.CTkButton(fields_frame, text=field,
                        ...
                        fg_color=self.colors['untoggled'], font=("Segoe UI", 10), text_color=self.colors['text'])
    ...
    #   - Creates Search results object (table) if it doesn't exist
    ...
    def on_search(self, query):
        if self.search_results_table:
            ...
            # If the search table doesn't exist, we create a new instance of it for our window
